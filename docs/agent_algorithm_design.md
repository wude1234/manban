...
profile = hot_v76_d010_196038_106205150
base = v30 driver-specific planner
upgrade = v32-v76 counterfactual memory + phase action gates + low-efficiency route repair + exact sequence probing + wait-as-route-plan teacher + schedule-aware value teacher + two-step route rebase + clean harness ablation + D010 active reposition and mutable month-end sequence teacher
```
