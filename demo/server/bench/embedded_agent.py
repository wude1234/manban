...
class EmbeddedDecisionEnvironment:
    ...
    def __init__(
        ...
        *,
        ...
        nearest_cargo_limit_by_driver: dict[str, int] | None = None,
        ...
        self._nearest_cargo_limit_by_driver = nearest_cargo_limit_by_driver or {}
    ...
    def query_cargo(self, driver_id: str, latitude: float, longitude: float) -> dict[str, Any]:
        ...
        nearest_limit = self._nearest_cargo_limit_by_driver.get(did, self._nearest_cargo_limit)
        ...
        self._logger.info(
            "query_cargo ok driver_id=%s items=%s limit=%s scan_cost_min=%s",
            driver_id,
            len(items),
            nearest_limit,
            scan_cost_minutes,
