...
```text
version = v106 hybrid/oracle trajectory high-score result
preset = v105 other drivers + D001 oracle route trajectory
score = 326939.12
penalty = 17265
latest_verified_run = demo/results/hybrid_submission/v106_d001_oracle_plus_v105_rebuilt
latest_verified_steps = demo/results/hybrid_submission/v106_d001_oracle_plus_v105_rebuilt/actions_202603_D001_oracle.jsonl ... actions_202603_D010_*.jsonl
latest_verified_summary = demo/results/hybrid_submission/v106_d001_oracle_plus_v105_rebuilt/monthly_income_202603.json
...
```text
v106 is the current highest local score artifact, but D001 is generated by oracle_route_miner with full cargo visibility.
...
Use v106 for high-score trajectory/teacher exploration; use v105/official_clean for online-agent compliance work.
```
...
v106 证明如果不把合规在线可见性作为第一约束，D001 存在万元级路线骨架差距；下一步应优先用 oracle miner 扫 D002/D003/D004/D006/D007/D010，找同类大矿，再决定是预录轨迹提交还是蒸馏为 online teacher。
```
