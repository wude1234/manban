...
```text
version = v169 D003/D008 exact-tail oracle trajectory high-score result
preset = v169_d003_d008_exacttail
score = 376333.36
penalty = 76515
latest_verified_run = demo/results/hybrid_submission/v169_d003_d008_exacttail
latest_verified_steps = demo/results/hybrid_submission/v169_d003_d008_exacttail/actions_202603_D*.jsonl
latest_verified_summary = demo/results/hybrid_submission/v169_d003_d008_exacttail/monthly_income_202603.json
...
```text
v169 is the current highest local score artifact. It keeps the high-score hybrid oracle base, then applies exact-tail improvements for D003 and D008. D003 improves 41880.67 -> 41906.49 via seed:D003:28 > 300820 > 482426 > 484386 > 206199 > 210030. D008 improves 38880.91 -> 38967.71 via seed:D008:27 > 180213 > 298622 > 194166 > 197179 > 203930 > 484386.
...
Use v169 for high-score trajectory/teacher exploration; use v105/official_clean for online-agent compliance work. Latest legal distilled-online-value v1 is a negative control: official_clean 275973.46 > official_distilled_value 272961.58.
```
...
v132 added D006 prefix18 tightdist tail mining:
...
v136 added D009 prefix40 daily-home tail repair on top of v134:
  D009 20120.85 -> 20253.56, +132.71
  gross 61428.04 -> 60333.47, distance 14338.13 -> 14119.94, penalty 19800 -> 18900
  full hybrid score = 373687.60, penalty 77215
  v135/v136 negatives: full daily-home replanning and early release points p20/p25/p30/p35 destroy gross. D009 only improves when the high-gross path is preserved until the final two days and the last tail is repaired.
v137 narrowed D009 repair to the final order:
  D009 20253.56 -> 20618.27, +364.71 vs v136 and +497.42 vs v134
...
v140 added prefix30 tail repairs on top of v138:
  D001 44542.66 -> 44568.48, +25.82
  D002 39036.56 -> 39062.38, +25.82
  D004 45488.41 -> 45514.23, +25.82
...
v143 continued D010 p58 with explicit low-distance scoring:
  D010 34514.53 -> 34744.56, +230.03
  gross 51883.72 -> 52098.01, distance 10536.13 -> 10525.63, penalty stays 1565
  full hybrid score = 375294.77, penalty 76315
  D010 p58 strictdist/high-order 63-order candidates had higher gross but worse penalty/net. D008 p29 and D005 p30 low-distance probes only reproduced current routes, so the new gain is D010-specific.
```
